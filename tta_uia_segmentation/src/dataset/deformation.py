...
def make_roi_mask(labels, roi_type="fg_only"):
    ...
    for i in range(roi_mask.shape[0]):
        ...
        if fg_indices.shape[1] != 0:
            ...
            roi_mask[i, fg_indices[0, :], fg_indices[1, :]] = 1.0
        else:
            roi_mask[i, :, :] = 1.0
    ...
    for i in range(shape[0]):
        ...
        for _ in range(num_noise_squares):
            ...
            if mask_type == "random":
                ...
                # ====================
                wrong_labels[
                    i, mcx - r : mcx + r, mcy - r : mcy + r, np.random.randint(nlabels)
                ] = 1
                ...
                wrong_labels[i, mcx - r : mcx + r, mcy - r : mcy + r, :] = labels_1hot[
                    i, mcx_src - r : mcx_src + r, mcy_src - r : mcy_src + r, :
                ]
...
def make_noise_masks_3d(
    ...
    for _ in range(num_noise_squares):
        ...
        if mask_type == "squares_jigsaw":
            ...
            labels_[mcx - r : mcx + r, mcy - r : mcy + r, mcz - r : mcz + r] = labels[
                mcx_src - r : mcx_src + r,
                mcy_src - r : mcy_src + r,
                mcz_src - r : mcz_src + r,
            ]
