...
class DiffusionTTA:
    ...
    def _sample_t_noise_pairs(
        ...
        assert len(t_values) == num_samples * num_imgs_per_volume, 'Number of samples must match the number of noise samples'
        ...
        assert len(t_dl) == len(noise_dl) == num_samples, 'Number of samples must match the number of noise samples'
