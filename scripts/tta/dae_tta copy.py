...
from utils.io import load_config, dump_config, print_config, save_checkpoint, write_to_csv, deep_get, rewrite_config_arguments
from utils.utils import seed_everything, get_seed, define_device
...
def preprocess_cmd_args() -> argparse.Namespace:
    ...
    # TODO: Complete the description for these command line args
    parser.add_argument('--dae_dir')
    parser.add_argument('--seg_dir')
    parser.add_argument('--wandb_log', type=lambda s: s.strip().lower() == 'true', 
                        help='Log tta to wandb. Default: False.')
...
def get_configuration_arguments() -> tuple[dict, dict, dict]:
    ...
    return dataset_config, model_config, tta_config
...
if __name__ == '__main__':
    ...
    # :=========================================================================:
    dataset_config, model_config, tta_config = get_configuration_arguments()
