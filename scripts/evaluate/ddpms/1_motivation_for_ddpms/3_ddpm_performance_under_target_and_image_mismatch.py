"""
Assess how does denoising performance degrades when there is a mismatch between segmentation mask and the image 

We do this in three ways:
  1. for a given image, use another image from the same patient but from a very different cut
