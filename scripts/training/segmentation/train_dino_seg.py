...
def preprocess_cmd_args() -> argparse.Namespace:
    ...
    # :=========================================================================:
    parser.add_argument(
        "--dino_model", type=str, help='Name of DINO model to use. Default: "large"'
    )
    parser.add_argument("--svd_path", type=str, help="Path to SVD model. Default: None")
    parser.add_argument(
        "--precalculated_fts",
        type=parse_bool,
        help="Whether to use precalculated features. Default: False",
    )
    ...
    # :=========================================================================:
    parser.add_argument(
        "--da_ratio", type=float, help="Ratio of images to apply DA to. Default: 0.25"
    )
    ...
    parser.add_argument(
        "--trans_min",
        type=float,
        help="Minimum value for translation augmentation. Default: -10",
    )
    parser.add_argument(
        "--trans_max",
        type=float,
        help="Maximum value for translation augmentation. Default: 10",
    )
    parser.add_argument(
        "--rot_min",
        type=float,
        help="Minimum value for rotation augmentation. Default: -10",
    )
    parser.add_argument(
        "--rot_max",
        type=float,
        help="Maximum value for rotation augmentation. Default: 10",
    )
    parser.add_argument(
        "--scale_min",
        type=float,
        help="Minimum value for zooming augmentation. Default: 0.9",
    )
    parser.add_argument(
        "--scale_max",
        type=float,
        help="Maximum value for zooming augmentation. Default: 1.1",
    )
    ...
    parser.add_argument(
        "--brightness_min",
        type=float,
        help="Minimum value for brightness augmentation. Default: 0.0",
    )
    parser.add_argument(
        "--brightness_max",
        type=float,
        help="Maximum value for brightness augmentation. Default: 0.0",
    )
    parser.add_argument(
        "--noise_mean",
        type=float,
        help="Mean value for noise augmentation. Default: 0.0",
    )
    parser.add_argument(
        "--noise_std",
        type=float,
        help="Standard deviation value for noise augmentation. Default: 0.0",
    )
...
if __name__ == "__main__":
    ...
    if wandb_log:
        wandb.save(
            os.path.join(wandb_dir, trainer.last_checkpoint_name),
            base_path=wandb_dir,
        )
